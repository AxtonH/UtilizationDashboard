...
import {
  ...
  isStrategyAndProject,
  isQuarterPeriodKey,
  monthsInCalendarQuarter,
  previousCalendarQuarterMonths,
  getPrevQuarterKey,
  boundsFromSelectedPeriod,
  comparisonLabelForPeriod,
  getPrevPeriodKey,
  normalizeAgreementTypeSafe,
  recalculateAgreementTypeTotals,
  recalculateSalesOrdersAgreementTotals,
  recalculateSalesOrdersProjectTotals,
  calculateComparison,
  computeFilterComparisonFromBreakdown,
  getPrevMonthKey,
  recalculateSubscriptionStats,
...
function initSalesDashboard() {
    ...
    setCurrentMonthProvider(() => currentMonth);
    let isLoading = false;
